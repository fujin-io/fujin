...
type InitRequest struct {
	...
	ConfigOverrides map[string]string      `protobuf:"bytes,2,rep,name=config_overrides,json=configOverrides,proto3" json:"config_overrides,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Configuration overrides for connectors
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *InitRequest) GetConnector() string {
	if x != nil {
		return x.Connector
	}
	return ""
...
const file_grpc_v1_fujin_proto_rawDesc = "" +
	"\n" +
	"\x13grpc/v1/fujin.proto\x12\bfujin.v1\"0\n" +
	"\x06Header\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\"\xc6\x01\n" +
	"\vInitRequest\x12\x1c\n" +
	"\tconnector\x18\x01 \x01(\tR\tconnector\x12U\n" +
	"\x10config_overrides\x18\x02 \x03(\v2*.fujin.v1.InitRequest.ConfigOverridesEntryR\x0fconfigOverrides\x1aB\n" +
...
var file_grpc_v1_fujin_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
