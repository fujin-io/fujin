...
const file_grpc_v1_fujin_proto_rawDesc = "" +
	...
	"\bresponse2M\n" +
	"\fFujinService\x12=\n" +
	"\x06Stream\x12\x16.fujin.v1.FujinRequest\x1a\x17.fujin.v1.FujinResponse(\x010\x01B/Z-github.com/ValerySidorin/fujin/api/grpc/v1;v1b\x06proto3"
...
var file_grpc_v1_fujin_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
